...
<b>Made With ❤ BY @IET_Updates</b>"""
    HELP_TXT = """ʜᴇʏ {}
<b>No One Gonna Help You.. നിന്നെ ആരും സഹായിക്കാൻ വരില്ല. ഏതായാലും വന്നതല്ലേ.. താഴെ ഉള്ള ചാനലുകളിലും ഗ്രൂപ്പുകളിലും ഒക്കെ join ചെയ്തോളൂ</b>"""
